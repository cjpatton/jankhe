...
mod tests {
    ...
    fn poly_mol_test_field32() {
        {
            let a = Rq([FieldPrio2::from(0); 256]);
            let b = Rq([FieldPrio2::from(0); 256]);
            let r = Rq([FieldPrio2::from(0); 256]);
            assert_eq!(r, POLY_MUL_FIELD32.poly_mul(&a, &b));
        }

        {
            let mut a = Rq([FieldPrio2::from(0); 256]);
            a.0[7] = FieldPrio2::from(23);
            let b = Rq([FieldPrio2::from(0); 256]);
            let r = Rq([FieldPrio2::from(0); 256]);
            assert_eq!(r, POLY_MUL_FIELD32.poly_mul(&a, &b));
        }

        {
            let mut a = Rq([FieldPrio2::from(0); 256]);
            a.0[7] = FieldPrio2::from(23);
            let mut b = Rq([FieldPrio2::from(0); 256]);
            b.0[0] = FieldPrio2::from(1);
            let mut r = Rq([FieldPrio2::from(0); 256]);
            r.0[7] = FieldPrio2::from(23);
            assert_eq!(r, POLY_MUL_FIELD32.poly_mul(&a, &b));
        }

        {
            ...
            a.0[7] = FieldPrio2::from(23);
            let mut b = Rq([FieldPrio2::from(0); 256]);
            b.0[2] = FieldPrio2::from(1);
            let mut r = Rq([FieldPrio2::from(0); 256]);
            r.0[9] = FieldPrio2::from(23);
            assert_eq!(r, POLY_MUL_FIELD32.poly_mul(&a, &b));
        }

        {
            let mut a = Rq([FieldPrio2::from(0); 256]);
            a.0[255] = FieldPrio2::from(23);
            let mut b = Rq([FieldPrio2::from(0); 256]);
            b.0[1] = FieldPrio2::from(1);
            let mut r = Rq([FieldPrio2::from(0); 256]);
            r.0[0] = -FieldPrio2::from(23);
            assert_eq!(r, POLY_MUL_FIELD32.poly_mul(&a, &b));
        }
    }
}
...
lazy_static! {
    static ref POLY_MUL_FIELD32: NttParamD256<FieldPrio2> = NttParamD256 {
        num_levels: 7,
        ts: [
            // level 0
            FieldPrio2::from(37101870),
            // level 1
            FieldPrio2::from(741585712),
            FieldPrio2::from(3598607238),
            // level 2
            FieldPrio2::from(806554333),
            FieldPrio2::from(1951000133),
            FieldPrio2::from(2342252472),
            FieldPrio2::from(3453551898),
            // level 3
            FieldPrio2::from(3636360432),
            FieldPrio2::from(94600197),
            FieldPrio2::from(1061493678),
            FieldPrio2::from(1257999482),
            FieldPrio2::from(3814329721),
            FieldPrio2::from(1652941122),
            FieldPrio2::from(2310715122),
            FieldPrio2::from(968005177),
            // level 4
            FieldPrio2::from(1200391425),
            FieldPrio2::from(3128114347),
            FieldPrio2::from(3144662134),
            FieldPrio2::from(2338031628),
            FieldPrio2::from(2514265747),
            FieldPrio2::from(2035981459),
            FieldPrio2::from(1529924105),
            FieldPrio2::from(1062485934),
            FieldPrio2::from(2736287676),
            FieldPrio2::from(1199928303),
            FieldPrio2::from(2153873066),
            FieldPrio2::from(3007794534),
            FieldPrio2::from(3315127182),
            FieldPrio2::from(3286614862),
            FieldPrio2::from(3390200195),
            FieldPrio2::from(3256287785),
            // level 5
            FieldPrio2::from(3338450716),
            FieldPrio2::from(1412211970),
            FieldPrio2::from(2231294902),
            FieldPrio2::from(2332311142),
            FieldPrio2::from(1307269733),
            FieldPrio2::from(450697235),
            FieldPrio2::from(244348247),
            FieldPrio2::from(3758156457),
            FieldPrio2::from(1053258481),
            FieldPrio2::from(92087675),
            FieldPrio2::from(1333826233),
            FieldPrio2::from(111519058),
            FieldPrio2::from(2082220453),
            FieldPrio2::from(2275854045),
            FieldPrio2::from(2376732840),
            FieldPrio2::from(233092547),
            FieldPrio2::from(2540865360),
            FieldPrio2::from(3755564905),
            FieldPrio2::from(1911658643),
            FieldPrio2::from(1662364995),
            FieldPrio2::from(2466944101),
            FieldPrio2::from(343904673),
            FieldPrio2::from(2547492843),
            FieldPrio2::from(2998429760),
            FieldPrio2::from(2336372591),
            FieldPrio2::from(1199490242),
            FieldPrio2::from(1872953394),
            FieldPrio2::from(2071622990),
            FieldPrio2::from(3534174188),
            FieldPrio2::from(2476244411),
            FieldPrio2::from(493424184),
            FieldPrio2::from(3662366743),
            // level 6
            FieldPrio2::from(732210571),
            FieldPrio2::from(1387388861),
            FieldPrio2::from(2211011159),
            FieldPrio2::from(2051411929),
            FieldPrio2::from(2128038472),
            FieldPrio2::from(455471368),
            FieldPrio2::from(3375478641),
            FieldPrio2::from(1095926402),
            FieldPrio2::from(1203602651),
            FieldPrio2::from(4001273314),
            FieldPrio2::from(2559888380),
            FieldPrio2::from(1266769554),
            FieldPrio2::from(1633449874),
            FieldPrio2::from(1907625545),
            FieldPrio2::from(2335775177),
            FieldPrio2::from(1167616620),
            FieldPrio2::from(605652300),
            FieldPrio2::from(3790805617),
            FieldPrio2::from(3133861573),
            FieldPrio2::from(1971380815),
            FieldPrio2::from(1783028302),
            FieldPrio2::from(3416771867),
            FieldPrio2::from(431182099),
            FieldPrio2::from(1862980846),
            FieldPrio2::from(3608602060),
            FieldPrio2::from(4080480150),
            FieldPrio2::from(3607689144),
            FieldPrio2::from(246443101),
            FieldPrio2::from(823425083),
            FieldPrio2::from(2991413966),
            FieldPrio2::from(290531752),
            FieldPrio2::from(1919035878),
            FieldPrio2::from(1861358601),
            FieldPrio2::from(33203794),
            FieldPrio2::from(428353847),
            FieldPrio2::from(515308288),
            FieldPrio2::from(2391297049),
            FieldPrio2::from(457728520),
            FieldPrio2::from(2669609004),
            FieldPrio2::from(1994409282),
            FieldPrio2::from(2324680219),
            FieldPrio2::from(4044880694),
            FieldPrio2::from(3175721955),
            FieldPrio2::from(1039896012),
            FieldPrio2::from(667150930),
            FieldPrio2::from(733169939),
            FieldPrio2::from(2928991398),
            FieldPrio2::from(3708624912),
            FieldPrio2::from(3663542477),
            FieldPrio2::from(3790758596),
            FieldPrio2::from(3477962022),
            FieldPrio2::from(1159211526),
            FieldPrio2::from(3379248674),
            FieldPrio2::from(224001267),
            FieldPrio2::from(2679495740),
            FieldPrio2::from(2195191829),
            FieldPrio2::from(3912533879),
            FieldPrio2::from(1246964281),
            FieldPrio2::from(4238346518),
            FieldPrio2::from(229463435),
            FieldPrio2::from(2101696342),
            FieldPrio2::from(3898167658),
            FieldPrio2::from(3551465356),
            FieldPrio2::from(735471256),
        ],
        us: [
            // level 0
            FieldPrio2::from(4256816851),
            // level 1
            FieldPrio2::from(3552333009),
            FieldPrio2::from(695311483),
            // level 2
            FieldPrio2::from(3487364388),
            FieldPrio2::from(2342918588),
            FieldPrio2::from(1951666249),
            FieldPrio2::from(840366823),
            // level 3
            FieldPrio2::from(657558289),
            FieldPrio2::from(4199318524),
            FieldPrio2::from(3232425043),
            FieldPrio2::from(3035919239),
            FieldPrio2::from(479589000),
            FieldPrio2::from(2640977599),
            FieldPrio2::from(1983203599),
            FieldPrio2::from(3325913544),
            // level 4
            FieldPrio2::from(3093527296),
            FieldPrio2::from(1165804374),
            FieldPrio2::from(1149256587),
            FieldPrio2::from(1955887093),
            FieldPrio2::from(1779652974),
            FieldPrio2::from(2257937262),
            FieldPrio2::from(2763994616),
            FieldPrio2::from(3231432787),
            FieldPrio2::from(1557631045),
            FieldPrio2::from(3093990418),
            FieldPrio2::from(2140045655),
            FieldPrio2::from(1286124187),
            FieldPrio2::from(978791539),
            FieldPrio2::from(1007303859),
            FieldPrio2::from(903718526),
            FieldPrio2::from(1037630936),
            // level 5
            FieldPrio2::from(955468005),
            FieldPrio2::from(2881706751),
            FieldPrio2::from(2062623819),
            FieldPrio2::from(1961607579),
            FieldPrio2::from(2986648988),
            FieldPrio2::from(3843221486),
            FieldPrio2::from(4049570474),
            FieldPrio2::from(535762264),
            FieldPrio2::from(3240660240),
            FieldPrio2::from(4201831046),
            FieldPrio2::from(2960092488),
            FieldPrio2::from(4182399663),
            FieldPrio2::from(2211698268),
            FieldPrio2::from(2018064676),
            FieldPrio2::from(1917185881),
            FieldPrio2::from(4060826174),
            FieldPrio2::from(1753053361),
            FieldPrio2::from(538353816),
            FieldPrio2::from(2382260078),
            FieldPrio2::from(2631553726),
            FieldPrio2::from(1826974620),
            FieldPrio2::from(3950014048),
            FieldPrio2::from(1746425878),
            FieldPrio2::from(1295488961),
            FieldPrio2::from(1957546130),
            FieldPrio2::from(3094428479),
            FieldPrio2::from(2420965327),
            FieldPrio2::from(2222295731),
            FieldPrio2::from(759744533),
            FieldPrio2::from(1817674310),
            FieldPrio2::from(3800494537),
            FieldPrio2::from(631551978),
            // level 6
            FieldPrio2::from(3561708150),
            FieldPrio2::from(2906529860),
            FieldPrio2::from(2082907562),
            FieldPrio2::from(2242506792),
            FieldPrio2::from(2165880249),
            FieldPrio2::from(3838447353),
            FieldPrio2::from(918440080),
            FieldPrio2::from(3197992319),
            FieldPrio2::from(3090316070),
            FieldPrio2::from(292645407),
            FieldPrio2::from(1734030341),
            FieldPrio2::from(3027149167),
            FieldPrio2::from(2660468847),
            FieldPrio2::from(2386293176),
            FieldPrio2::from(1958143544),
            FieldPrio2::from(3126302101),
            FieldPrio2::from(3688266421),
            FieldPrio2::from(503113104),
            FieldPrio2::from(1160057148),
            FieldPrio2::from(2322537906),
            FieldPrio2::from(2510890419),
            FieldPrio2::from(877146854),
            FieldPrio2::from(3862736622),
            FieldPrio2::from(2430937875),
            FieldPrio2::from(685316661),
            FieldPrio2::from(213438571),
            FieldPrio2::from(686229577),
            FieldPrio2::from(4047475620),
            FieldPrio2::from(3470493638),
            FieldPrio2::from(1302504755),
            FieldPrio2::from(4003386969),
            FieldPrio2::from(2374882843),
            FieldPrio2::from(2432560120),
            FieldPrio2::from(4260714927),
            FieldPrio2::from(3865564874),
            FieldPrio2::from(3778610433),
            FieldPrio2::from(1902621672),
            FieldPrio2::from(3836190201),
            FieldPrio2::from(1624309717),
            FieldPrio2::from(2299509439),
            FieldPrio2::from(1969238502),
            FieldPrio2::from(249038027),
            FieldPrio2::from(1118196766),
            FieldPrio2::from(3254022709),
            FieldPrio2::from(3626767791),
            FieldPrio2::from(3560748782),
            FieldPrio2::from(1364927323),
            FieldPrio2::from(585293809),
            FieldPrio2::from(630376244),
            FieldPrio2::from(503160125),
            FieldPrio2::from(815956699),
            FieldPrio2::from(3134707195),
            FieldPrio2::from(914670047),
            FieldPrio2::from(4069917454),
            FieldPrio2::from(1614422981),
            FieldPrio2::from(2098726892),
            FieldPrio2::from(381384842),
            FieldPrio2::from(3046954440),
            FieldPrio2::from(55572203),
            FieldPrio2::from(4064455286),
            FieldPrio2::from(2192222379),
            FieldPrio2::from(395751063),
            FieldPrio2::from(742453365),
            FieldPrio2::from(3558447465),
        ],
        c: FieldPrio2::from(4260372481), // 2^-7
    };

    static ref POLY_MUL_FIELD128: NttParamD256<Field128> = NttParamD256 {
        num_levels: 7,
        ts: [
            // level 0
